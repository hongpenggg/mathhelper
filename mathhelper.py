...
Thanks for reading! 🍻
            ...
            print("\nHey! If you can access the help page, you're pretty much set to use this tool.")
            print("When you see an input field, enter only numbers, unless otherwise specified.")
            print("If you need more help, hit 'Read Developer Docs' -> 'Contact Information'.")

            askUser7 = input("Would you like to return to the main menu? (y/n): ")
            if askUser7 == "y":
                print("\n")
                validation = True
            else:
